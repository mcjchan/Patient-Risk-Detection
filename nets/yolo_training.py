...
def jaccard(_box_a, _box_b):
    ...
    # Calculate anchor and ground truth area
...
def box_ciou(b1, b2):
    ...
    """
    # Anchor top left corner and bottom right corner
    b1_xy = b1[..., :2]
    b1_wh = b1[..., 2:4]
    b1_wh_half = b1_wh/2.
    b1_mins = b1_xy - b1_wh_half
    b1_maxes = b1_xy + b1_wh_half
    # Ground truth top left corner and bottom right corner
    b2_xy = b2[..., :2]
    b2_wh = b2[..., 2:4]
    b2_wh_half = b2_wh/2.
    ...
    # The min box contain both Anchor and ground truth top left corner and bottom right corner
...
class YOLOLoss(nn.Module):
    ...
    def forward(self, input, targets=None):
        ...
        #-------------------------------------------------#
        #   The size of scaled_anchors fit feature layer
        #-------------------------------------------------#
        ...
        #---------------------------------------------------------------------#
        #   Find put which anchor box(es) contain object(s)
        #   By comparing anchor box and ground truth
        #   mask        batch_size, 3, in_h, in_w   With target
        #   noobj_mask  batch_size, 3, in_h, in_w   Without target
        #   t_box       batch_size, 3, in_h, in_w, 4   Coordinates value
        #   tconf       batch_size, 3, in_h, in_w   Conf value
        #   tcls        batch_size, 3, in_h, in_w, num_classes  Class(es) value
        #----------------------------------------------------------------------#
        ...
        #---------------------------------------------------------------#
        #   Decode : The overlap ratio of predicted and actuarial
        #----------------------------------------------------------------#
        ...
        #---------------------------------------------------------------#
        #   Calcute the predicted and actuarial's CIOU
        #----------------------------------------------------------------#
    ...
    def get_target(self, target, anchors, in_w, in_h, ignore_threshold):
        ...
        for b in range(bs):
            ...
            for i, best_n in enumerate(best_ns):
                ...
                #   gi and gj : feature points' x y axis
                #   gx and gy : x y axis coordinates
                #   gw and gh : weight and height
                #-------------------------------------------------------------#
                gi = gis[i].long()
                gj = gjs[i].long()
                gx = gxs[i]

...
class DecodeBox(nn.Module):
    def __init__(self, anchors, num_classes, img_size):
        ...
        #---------------------------------------------------------------------#
        #   13x13 feature layer's anchor = [142, 110], [192, 243], [459, 401]
        #   26x26 feature layer's anchor = [36, 75], [76, 55], [72, 146]
        #   52x52 feature layer's anchor = [12, 16], [19, 36], [40, 28]
        #---------------------------------------------------------------------#
    ...
    def forward(self, input):
        ...
        #----------------------------------------------------------#
        #  Anchor's centre and top left corner
        #   batch_size,3,13,13
        #----------------------------------------------------------#
...
def non_max_suppression(prediction, num_classes, conf_thres=0.5, nms_thres=0.4):
    ...
    for image_i, image_pred in enumerate(prediction):
        ...
        #----------------------------------------------------------#
        #   Screening based on class_conf
        #----------------------------------------------------------#
        conf_mask = (image_pred[:, 4] * class_conf[:, 0] >= conf_thres).squeeze()

        #----------------------------------------------------------#
        #   Predicting based on class_conf
        #----------------------------------------------------------#
        ...
        for c in unique_labels:
            ...
            # # Ranking all detected object(s) by class_conf
